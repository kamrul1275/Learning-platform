    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> ধামরাই, ঢাকা </p>
                <p class="footer-text"><i class="fas fa-phone"></i> 01981337121 </p>
                <p class="footer-text"><i class="fas fa-envelope"></i> Kamrulhassan5343@gmail.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব কামরুল হাসান দ্বারা সংরক্ষিত; ২০১৯-২০২০ </p>
</div>
